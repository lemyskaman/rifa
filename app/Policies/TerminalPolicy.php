...
class TerminalPolicy
{
    ...
    {
        return $user->hasPermissionTo('list terminals');
    }
    ...
    {
        return $user->hasPermissionTo('view terminals');
    }
    ...
    {
        return $user->hasPermissionTo('create terminals');
    }
    ...
    {
        return $user->hasPermissionTo('update terminals');
    }
    ...
    {
        return $user->hasPermissionTo('delete terminals');
    }
