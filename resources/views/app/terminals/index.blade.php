<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.terminals.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $terminal)
                                        <a
                                            href="{{ route('terminals.show', $terminal) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $terminal)
                                        <form
                                            action="{{ route('terminals.destroy', $terminal) }}"
                                            method="POST"
